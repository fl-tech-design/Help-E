...
const byte LIGHT_OFF_INDI_R_ON = B01000000; // config Arduino Nano
//const byte LIGHT_OFF_INDI_R_ON = B00001100; // config Wemos D1 mini

const byte LIGHT_ON_INDI_R_ON  = B11111100; // config Arduino Nano
//const byte LIGHT_ON_INDI_R_ON  = B11001100; // config Wemos D1 mini

const byte LIGHT_ON_INDI_R_OFF = B10111100; // config Arduino Nano
//const byte LIGHT_ON_INDI_R_OFF = B11000000; // config Wemos D1 mini

const byte LIGHT_OFF_INDI_L_ON = B00001000; // config Arduino Nano
//const byte LIGHT_OFF_INDI_L_ON = B11000000; // config Wemos D1 mini

const byte LIGHT_ON_INDI_L_ON = B11111100;  // config Arduino Nano
//const byte LIGHT_ON_INDI_L_ON = B11001100;  // config Wemos D1 mini


const byte LIGHT_ON_INDI_L_OFF = B11110100; // config Arduino Nano
